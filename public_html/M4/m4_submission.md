...
<tr><td> <em>Generated: </em> 2/20/2022 10:13:41 PM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-008-S22/init-db-setup/grade/ll452" target="_blank">Grading</a></td></tr></table>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98070780/154874974-be0200f1-8770-4d7a-b038-a186394099cf.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Heroku Dev Screenshot<br></p>
</td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98070780/154875094-fed05839-0cf3-4ebc-914b-bcf9380c3e96.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>MySQL VS Code  Extension Table Screenshot<br></p>
</td></tr>
</table></td></tr>
</table></td></tr>
...
<tr><td> <em>Response:</em> <p>I learned that PHP has filter feature that is used to validate and<br>sanitize external inputs. I learned that it is important to always filter data<br>going into databases and servers because invalid data can lead to security problems<br>and potentially break your software, programs or webpage. Ideally its good practice to<br>use PHP filters, filter_var is a function that both validate and sanitize data.<br>The filter_var also have different types of checks where it can filter emails,<br>strings, integers, IPs v4 or v6,  URLs, integers within a range, and<br>potentially many more.<br></p><br></td></tr>
...
<tr><td> <em>Response:</em> <p>I encountered a problem in class and asked Professor Toegel for help. He<br>said my PHP was improperly installed. After I merged and deployed it on<br>Heroku there seemed to be no more issues.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 3: </em> Add the pull request link (ProjectSetup to Dev)</td></tr>
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://github.com/ll452/IT202/pull/11">https://github.com/ll452/IT202/pull/11</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://ll452-prod.herokuapp.com/Project/sql/init_db.php">https://ll452-prod.herokuapp.com/Project/sql/init_db.php</a> </td></tr>
</table></td></tr>
<table><tr><td><em>Grading Link: </em><a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-008-S22/init-db-setup/grade/ll452" target="_blank">Grading</a></td></tr></table>